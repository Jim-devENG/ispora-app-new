  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-20 md:bottom-6 left-6 bg-sky-500 text-white p-4 rounded-full shadow-lg hover:bg-sky-600 transition-colors z-40 flex items-center gap-2"
